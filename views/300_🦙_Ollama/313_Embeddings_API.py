...
for doc in documents:
    response = ollama.embeddings(model='gemma3:1b', prompt=doc)
    doc_embeddings.append(response['embedding'])

# Search query
query = "Tell me about coding languages"
query_response = ollama.embeddings(model='gemma3:1b', prompt=query)
...
class VectorStore:
    ...
    def add(self, text):
        ...
        response = ollama.embeddings(model='gemma3:1b', prompt=text)
    ...
    def search(self, query, top_k=5):
        ...
        # Get query embedding
        response = ollama.embeddings(model='gemma3:1b', prompt=query)
...
models = {
    "gemma3:1b": "General purpose, 4096 dims",
