...
def process_single(prompt, model='llama2'):
...
def batch_process_with_progress(prompts, model='llama2'):
...
def robust_batch_process(prompts, model='llama2', max_retries=3):
...
def stream_batch(prompts, model='llama2'):
...
st.code("""
def process_in_chunks(prompts, chunk_size=50, model='llama2'):
